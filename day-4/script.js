...
function partTwoB () {
  ...
  let flavors = ["Chocolate", "Mint Chocolate", "Vanilla", "Chocolate Swirl"];
  // 2. Find the length of the array
...
function partFourB () {
  ...
  newflavor = prompt("What is your favorite flavor?");
  ...
  for (let i = 0; i < highNumber; i++) {messageList.innerHTML += `<li>${flavors[i]}</li>`;
}
}
